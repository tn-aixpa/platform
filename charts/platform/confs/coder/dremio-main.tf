...
variable "postgresql_creds_secret" {
  ...
  default     = "platform-owner-user.database-postgres-cluster.credentials.postgresql.acid.zalan.do"
}
...
variable "minio_platform_user_secret" {
  type = string
}
      ...
      spec {
        ...
        container {
          ...
          env {
            ...
            value_from {
              secret_key_ref {
                name = var.minio_platform_user_secret
                key  = "platformUser"
              }
            }
          }
